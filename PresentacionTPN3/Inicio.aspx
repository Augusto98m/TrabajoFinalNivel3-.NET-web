<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="PresentacionTPN3.Inicio" %>
  ...
  <asp:UpdatePanel runat="server">
   <ContentTemplate>
    <div class="container iniciado">   
        <h2>¡TE DAMOS LA BIENVENIDA A LA TIENDA VIRTUAL SMART TECH!</h2>
                       ...
                       <img src="<%#Eval("UrlImagen") %>" class="card-img-top foto" id="imgProduc">                        
                        <div class="card-body" style="height:184px;width:238px">
                            ...
                            <div class="row" style="flex-wrap:nowrap">                                
                                    <a style="width:100px" href="DetalleProducto.aspx?id=<%#Eval("Id") %>">Ver detalle</a>
